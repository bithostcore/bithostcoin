...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bithost.conf'
CONFIGFOLDER='/root/.bithost'
COIN_DAEMON='bithostd'
COIN_CLI='bithostd'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/bithostcore/bithostcoin/blob/master/Bithost-(Linux_Daemon).zip'
...
echo -e "Preparing the system to install ${GREEN}$COIN_NAME${NC} master node. This might take some time, grab some snacks while waiting."
...
function important_information() {
 ...
 echo -e "XNODE PRIVATEKEY is: ${RED}$COINKEY${NC}"
 ...
 echo -e "Use ${RED}$COIN_CLI masternode status${NC} to check your MN. A properly running Masternode will display ${RED}Status: 9${NC}"
